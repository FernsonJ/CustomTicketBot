...
client.on('guildCreate', guild => {
   const botownerid = "708111447183589396";
   const botownerid2 = "708111447183589396";
   const serverjoinch = client.channels.cache.get("1005178110557311031")
   //const botownerfix = client.users.fetch(botownerid);
   const botowner = client.users.cache.get("708111447183589396");
   const botowner2 = client.users.cache.get("708111447183589396");
...
client.on('guildDelete', guild => {
  const owneridforleave = '708111447183589396';
  const owneridforleave2 = "708111447183589396";
  const serverleavech = client.channels.cache.get("1005178110557311031")
...
require("http").createServer((_, res) => res.end("CODE MADE BY TICKET SUPPORT TEAM DISCORD ID ! ! Đ4₥₣ɆⱤ₦#5214")).listen(8080)
